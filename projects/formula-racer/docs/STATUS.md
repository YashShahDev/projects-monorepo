...
The driving session (pause, focus loss, reset, camera) is done. Next, test-first at the
seams in the [P2 record](checkpoints/P2.md): a greybox track and car view with a
