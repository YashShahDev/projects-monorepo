...
- Next checkpoint: P6-C8 F1-style scenery and bench ([P6](checkpoints/P6.md)).
...
| P6-C1–C7  | done    | [P6 record](checkpoints/P6.md)                                                |
| P6-C8–C11 | planned | [P6](phases/P6-polish.md)                                                     |
