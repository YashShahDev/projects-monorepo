...
- Next checkpoint: P6-C10 real-layout circuits ([P6](checkpoints/P6.md)).
...
| P6-C1–C9  | done    | [P6 record](checkpoints/P6.md)                                                |
| P6-C10–11 | planned | [P6](phases/P6-polish.md)                                                     |
