...
- Next checkpoint: P6-C6 racing line and braking guide ([P6](checkpoints/P6.md)).
...
| P6-C1–C5  | done    | [P6 record](checkpoints/P6.md)                                                |
| P6-C6–C10 | planned | [P6](phases/P6-polish.md)                                                     |
